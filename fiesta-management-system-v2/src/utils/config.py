queries = {
    ...
    "GET_ACCEPTED_MENU": "select i.items, m.date, a.menu_id from `groups` as g inner join approved_menu as a on g.menu_id = a.id inner join menu as m on a.menu_id = m.id inner join items as i on m.id = i.menu_id where g.id = %s;",
